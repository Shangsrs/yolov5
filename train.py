...
def parse_args():
    ...
    parser.add_argument('--data', type=str, default='data/cvt.yaml', help='data.yaml path')
    parser.add_argument('--hyp', type=str, default='data/hyp.scratch.yaml', help='hyperparameters path')
    parser.add_argument('--epochs', type=int, default=300)
    parser.add_argument('--batch-size', type=int, default=1, help='total batch size for all GPUs')
    parser.add_argument('--img-size', nargs='+', type=int, default=[5120, 3072], help='[train, test] image sizes')
    ...
    parser.add_argument('--log-imgs', type=int, default=1, help='number of images for W&B logging, max 100')
